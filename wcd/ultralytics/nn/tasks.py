...
from ultralytics.nn.modules import (DA,CAFM,DySample,FeedForward,Dynamic_conv2d,HWD,Conv_wave,
                                    PSConv,CLF_Model, C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x,
                                    Classify, Concat, attention_model,ScalSeq,Zoom_cat,Add,Conv,Conv2, ConvTranspose, Detect, DWConv, DWConvTranspose2d,
                                    Focus, GhostBottleneck, Pose, RepC3, RepConv,
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify,Conv, Dynamic_conv2d,Conv_wave, PSConv,CLF_Model,ConvTranspose, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
            ...
            args = [ch[f], *args]
        elif m is FeedForward:
            args = [ch[f], *args]
        elif m in (nn.BatchNorm2d, DA):
            args = [ch[f]]
